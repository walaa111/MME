...
var app = {
	...
	var inAppBrowserbRef = cordova.InAppBrowser.open('https://electrostar.ovplatform.tk', '_self', 'location=no,toolbar=no');
        inAppBrowserbRef = cordova.InAppBrowser.open('http://matthew.realdeal.com.eg/MME/', '_self', 'location=no,toolbar=no');
...
function initAd(){
        if ( window.plugins && window.plugins.AdMob ) {
            var ad_units = {
             ...
             android : {
                    banner: 'ca-app-pub-7251676025279948/4103711408',		//PUT ADMOB ADCODE HERE 
                    interstitial: 'ca-app-pub-7251676025279948/1936002629'	//PUT ADMOB ADCODE HERE 
                }
            };
